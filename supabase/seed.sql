...
insert into public.connection_cases (
  ...
  (
    ...
    '2026-09-30',
    'Fictional demo note: study agreement unsigned. Indicative headroom in this dataset no longer covers the 20 MW bidirectional request.'
  ),
  (
  ...
  (
    ...
    '2026-07-17',
    'Fictional demo note: internal 60-day follow-up elapsed on 17 July 2026. No operator reply is stored in this dataset.'
  ),
  (
    ...
    'NIA and permit pack',
    '2026-09-05',
    'Fictional demo note: completeness pack still missing NIA, landowner agreement and environmental permit ahead of 5 September 2026.'
  ),
  (
  ...
  (
    ...
    'Offer acceptance',
    '2026-11-09',
    'Fictional demo note: illustrative offer-acceptance window open until 9 November 2026. Not a real connection offer.'
  ),
  (
...
-- Gävle BESS: 10 required rows, 7 complete (~70% readiness). Remaining rows are
...
insert into public.project_requirements (
  ...
  ('a0000000-0000-4000-8000-000000000401', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000402', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Land rights', 'complete', true, 'land', null),
  ('a0000000-0000-4000-8000-000000000403', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Single-line diagram', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000404', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Load profile', 'incomplete', true, 'technical', '2026-08-29'),
  ('a0000000-0000-4000-8000-000000000405', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Technical appendix', 'missing', true, 'technical', '2026-09-12'),
  ('a0000000-0000-4000-8000-000000000406', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Permit timeline', 'in_progress', true, 'permit', '2026-09-30'),
  ('a0000000-0000-4000-8000-000000000407', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Grid study agreement', 'complete', true, 'grid', null),
  ('a0000000-0000-4000-8000-000000000408', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Site access memo', 'complete', true, 'land', null),
  ('a0000000-0000-4000-8000-000000000409', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Protection settings note', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000410', 'a0000000-0000-4000-8000-000000000101', 'a0000000-0000-4000-8000-000000000301', 'Point of connection sketch', 'complete', true, 'grid', null),
  ('a0000000-0000-4000-8000-000000000411', 'a0000000-0000-4000-8000-000000000104', 'a0000000-0000-4000-8000-000000000304', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000412', 'a0000000-0000-4000-8000-000000000104', 'a0000000-0000-4000-8000-000000000304', 'Screening memo', 'complete', true, 'permit', null),
  ('a0000000-0000-4000-8000-000000000413', 'a0000000-0000-4000-8000-000000000104', 'a0000000-0000-4000-8000-000000000304', 'Application form', 'in_progress', true, 'grid', '2026-09-05'),
  ('a0000000-0000-4000-8000-000000000414', 'a0000000-0000-4000-8000-000000000104', 'a0000000-0000-4000-8000-000000000304', 'Network Impact Assessment', 'missing', true, 'grid', '2026-09-05'),
  ('a0000000-0000-4000-8000-000000000415', 'a0000000-0000-4000-8000-000000000104', 'a0000000-0000-4000-8000-000000000304', 'Landowner Agreement', 'missing', true, 'land', '2026-09-05'),
  ('a0000000-0000-4000-8000-000000000416', 'a0000000-0000-4000-8000-000000000104', 'a0000000-0000-4000-8000-000000000304', 'Environmental Permit', 'missing', true, 'environmental', '2026-09-05'),
  ('a0000000-0000-4000-8000-000000000417', 'a0000000-0000-4000-8000-000000000102', 'a0000000-0000-4000-8000-000000000302', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000418', 'a0000000-0000-4000-8000-000000000102', 'a0000000-0000-4000-8000-000000000302', 'Land rights', 'complete', true, 'land', null),
  ('a0000000-0000-4000-8000-000000000419', 'a0000000-0000-4000-8000-000000000102', 'a0000000-0000-4000-8000-000000000302', 'Single-line diagram', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000420', 'a0000000-0000-4000-8000-000000000102', 'a0000000-0000-4000-8000-000000000302', 'Load profile', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000421', 'a0000000-0000-4000-8000-000000000102', 'a0000000-0000-4000-8000-000000000302', 'Technical appendix', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000422', 'a0000000-0000-4000-8000-000000000102', 'a0000000-0000-4000-8000-000000000302', 'Completeness checklist', 'in_progress', true, 'grid', '2026-10-15'),
  ('a0000000-0000-4000-8000-000000000423', 'a0000000-0000-4000-8000-000000000106', 'a0000000-0000-4000-8000-000000000305', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000424', 'a0000000-0000-4000-8000-000000000106', 'a0000000-0000-4000-8000-000000000305', 'Site coordinates pack', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000425', 'a0000000-0000-4000-8000-000000000106', 'a0000000-0000-4000-8000-000000000305', 'Enquiry form', 'complete', true, 'grid', null),
  ('a0000000-0000-4000-8000-000000000426', 'a0000000-0000-4000-8000-000000000106', 'a0000000-0000-4000-8000-000000000305', 'Land rights', 'in_progress', true, 'land', '2026-09-01'),
  ('a0000000-0000-4000-8000-000000000427', 'a0000000-0000-4000-8000-000000000106', 'a0000000-0000-4000-8000-000000000305', 'Single-line diagram', 'not_started', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000428', 'a0000000-0000-4000-8000-000000000103', 'a0000000-0000-4000-8000-000000000303', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000429', 'a0000000-0000-4000-8000-000000000103', 'a0000000-0000-4000-8000-000000000303', 'Enquiry pack', 'complete', true, 'grid', null),
  ('a0000000-0000-4000-8000-000000000430', 'a0000000-0000-4000-8000-000000000103', 'a0000000-0000-4000-8000-000000000303', 'Follow-up letter', 'in_progress', true, 'other', '2026-07-17'),
  ('a0000000-0000-4000-8000-000000000431', 'a0000000-0000-4000-8000-000000000103', 'a0000000-0000-4000-8000-000000000303', 'Land option', 'incomplete', true, 'land', null),
  ('a0000000-0000-4000-8000-000000000432', 'a0000000-0000-4000-8000-000000000109', 'a0000000-0000-4000-8000-000000000306', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000433', 'a0000000-0000-4000-8000-000000000109', 'a0000000-0000-4000-8000-000000000306', 'Connection offer review', 'complete', true, 'grid', null),
  ('a0000000-0000-4000-8000-000000000434', 'a0000000-0000-4000-8000-000000000109', 'a0000000-0000-4000-8000-000000000306', 'Commercial memo', 'in_progress', true, 'commercial', '2026-11-09'),
  ('a0000000-0000-4000-8000-000000000435', 'a0000000-0000-4000-8000-000000000109', 'a0000000-0000-4000-8000-000000000306', 'Offer acceptance pack', 'not_started', true, 'commercial', '2026-11-09'),
  ('a0000000-0000-4000-8000-000000000436', 'a0000000-0000-4000-8000-000000000110', 'a0000000-0000-4000-8000-000000000307', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000437', 'a0000000-0000-4000-8000-000000000110', 'a0000000-0000-4000-8000-000000000307', 'Load profile', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000438', 'a0000000-0000-4000-8000-000000000110', 'a0000000-0000-4000-8000-000000000307', 'Study input pack', 'in_progress', true, 'technical', '2026-09-12'),
  ('a0000000-0000-4000-8000-000000000439', 'a0000000-0000-4000-8000-000000000110', 'a0000000-0000-4000-8000-000000000307', 'Site layout', 'incomplete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000440', 'a0000000-0000-4000-8000-000000000111', 'a0000000-0000-4000-8000-000000000308', 'Project description', 'complete', true, 'technical', null),
  ('a0000000-0000-4000-8000-000000000441', 'a0000000-0000-4000-8000-000000000111', 'a0000000-0000-4000-8000-000000000308', 'Connection offer', 'complete', true, 'grid', null),
  ('a0000000-0000-4000-8000-000000000442', 'a0000000-0000-4000-8000-000000000111', 'a0000000-0000-4000-8000-000000000308', 'Agreement draft', 'in_progress', true, 'commercial', '2026-09-30'),
  ('a0000000-0000-4000-8000-000000000443', 'a0000000-0000-4000-8000-000000000111', 'a0000000-0000-4000-8000-000000000308', 'Execution copies', 'incomplete', true, 'commercial', null);
