  ...
  return (
    <section className="rounded-md border border-line bg-surface/95 p-3 text-xs backdrop-blur-sm">
      ...
      <div className="mt-2 space-y-2">
        ...
        <LegendSwatch shape="square" color="#2A7A6F" label="Opportunity" />
        <LegendSwatch shape="square" color="#163A34" label="Shortlisted opportunity" />
        <LegendSwatch shape="square" color="#8A8F98" label="Rejected opportunity" />
