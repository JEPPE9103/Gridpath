    ...
    <AppFrame path="/opportunities">
      <div className="min-h-[280px] bg-canvas sm:min-h-[360px]">
        ...
        <div className="relative">
          ...
          <div className="p-3 sm:absolute sm:bottom-3 sm:left-3 sm:w-[300px] sm:p-0">
    ...
    <article className="rounded-lg border border-line/80 bg-surface/92 p-3 shadow-[0_18px_36px_-22px_rgba(26,30,36,0.5)] backdrop-blur-[8px]">
      ...
      <dl className="mt-3 space-y-1.5 text-[11px]">
        ...
        <div>
          ...
          <dd className="mt-0.5 font-medium leading-4 text-ink">{site.topUnknown}</dd>
        </div>
        <div>
          <dt className="text-muted">Recommended next</dt>
          <dd className="mt-0.5 font-medium leading-4 text-ink">{site.recommendedNext}</dd>
        </div>
