      ...
      <div className="mx-auto grid max-w-[1200px] items-center gap-10 px-5 py-12 sm:gap-12 sm:px-8 sm:py-16 md:px-10 lg:grid-cols-[0.92fr_1.08fr] lg:py-24">
        <div>
          ...
          <h1 className="mt-4 max-w-xl text-[32px] font-semibold leading-[1.1] tracking-tight text-ink sm:text-[40px] md:text-[52px] lg:text-[56px]">
            Screen, manage and monitor grid-connected development.
          </h1>
          <p className="mt-5 max-w-md text-[15px] leading-7 text-muted sm:text-base">
            Place sites against official Swedish grid context, run connection cases and readiness
            in one workspace, and review published plan changes that intersect your portfolio.
          </p>
          ...
          <p className="mt-5 text-sm text-muted">
            Built for energy developers working Swedish BESS and renewable portfolios. Forecast need
            for transfer capacity is never treated as available MW.
          </p>
        </div>
