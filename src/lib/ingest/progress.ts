...
export const DISCOVERY_PROGRESS_WAIT_COPY =
  "The first search in a new area may load official land cover, terrain, road, flood, ground and detailed elevation. A repeat search over the same area reuses the cache.";
...
export const DISCOVERY_PROGRESS_STAGES = [
  ...
  {
    id: "ground",
    title: "Loading ground / soil",
    detail: "Fetching missing SGU surficial geology for this Search Area, or reusing cache.",
  },
  {
    id: "detailed_terrain",
    title: "Loading detailed terrain",
    detail: "Fetching missing Lantmäteriet 1 m DTM summaries for this Search Area, or reusing cache.",
  },
  {
    id: "screening",
