...
export const SAMPLE_CANDIDATE_SITES = [
  {
    ...
    summary:
      "Clear environmental screens, road access within preference, and official network covering. Ranking is for investigation, not constructability.",
    ...
    keyRisk: "Ground mapping has no classes here — not a geotechnical clearance",
    whyThisSite:
      "Protection, Natura 2000, land cover, terrain, road proximity and network covering all evaluated without hard blockers.",
    topConstraint: "Residential proximity is not evaluated yet",
    topUnknown: "Ground / soil — no mapped classes in the evaluated SGU dataset",
    recommendedNext: "Confirm surficial geology with a site investigation before lease talks",
    longitude: 15.166,
    latitude: 59.045,
  },
  {
    ...
    summary:
      "Strong land-cover fit and covering geography; farther road access than Site A. EBH silence is not clearance.",
    municipality: "Örebro County",
    contiguousHa: "11.2",
    covering: "Official local-network covering",
    evidenceSummary: "8 of 11 evidence categories evaluated",
    keyPositive: "NMD 2023 land cover evaluated",
    keyRisk: "Environmental history — no EBH records nearby is not clearance",
    whyThisSite: "Qualifying land cover and official covering; environmental screens clear.",
    topConstraint: "Road proximity farther than Site A (~420 m)",
    topUnknown: "Environmental history — absence of EBH objects is not clearance",
    recommendedNext: "Request an EBH desk check before prioritizing over Site A",
    longitude: 15.205,
    latitude: 59.102,
  },
  {
    ...
    summary:
      "Largest remaining area, weaker investigation priority — more ground and history unknowns.",
    municipality: "Örebro County",
    contiguousHa: "14.8",
    covering: "Official local-network covering",
    evidenceSummary: "7 of 11 evidence categories evaluated",
    keyPositive: "Inside the Search Area",
    keyRisk: "Ground and environmental history both need follow-up",
    whyThisSite: "Largest contiguous qualifying footprint inside the Search Area.",
    topConstraint: "Terrain edge cases near the parcel boundary",
    topUnknown: "Ground / soil and environmental history both unresolved for diligence",
    recommendedNext: "Deprioritize until ground evidence improves",
    longitude: 15.042,
    latitude: 59.118,
  },
] as const;
...
export const SAMPLE_EVIDENCE_COVERAGE: EvidenceCoverageView = {
  ...
  items: [
    ...
    },
    {
      ...
      state: "evaluated",
      summary:
        "No mapped EBH records nearby — absence of objects is not clearance",
      provenance: "official",
      required: true,
      sourceDetail: {
